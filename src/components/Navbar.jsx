...
export default function Navbar({ cartCount, badgePop, onCartOpen }) {
  ...
  const navLinks = [
    { label: 'Jerseys', href: '#catalog', filter: 'jersey' },
    { label: 'Caps', href: '#catalog', filter: 'cap' },
    { label: 'All Drops', href: '#catalog', filter: 'all' },
  ]
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="relative flex items-center justify-center w-10 h-10 rounded-full glass hover:border-[#39FF14]/40 transition-all duration-300 hover:neon-border-green group"
            >
              <ShoppingCart
                size={20}
                className="text-gray-300 group-hover:text-[#39FF14] transition-colors"
              />
